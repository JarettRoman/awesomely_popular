<?php
	...
	*/
	...
	Finds the current views of a post and adds one to it by updating the postmeta.  The meta key used is
	"awepop_views".
	...
	*/
	...
	function awepop_show_views($singluar = "view", $plural = "views", $before = "This post has: ") {
		global $post;
